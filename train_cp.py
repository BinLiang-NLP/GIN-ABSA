...
from models import LSTM, IAN, MemNet, RAM, TD_LSTM, Cabasc, ATAE_LSTM, TNet_LF, AOA, MGAN,GCNN, GIN
...
class Instructor:
    ...
    def _train(self, criterion, optimizer, train_data_loader, val_data_loader,classifier_data_loader=None):
        ...
        logger.info('max acc:'+ str(max_val_acc)+'  f1:'+str(max_val_acc_withf1))
        logger.info('max f1:'+str(max_val_f1)+'   acc:'+str(max_val_f1_withacc))
        return path
    ...
    def run(self):
        ...
        self.model.eval()
        test_acc, test_f1,test_result = self._evaluate_acc_f1(test_data_loader)
...
def main():
    ...
    input_colses = {
        ...
        'gcnn':['text_raw_indices','aspect_indices'],
